      ...
      <div className="container">
        ...
        <div className="mb-8">
          <motion.span
            ...
            className="text-xs font-medium text-primary uppercase tracking-widest block mb-2"
          >
            Just Arrived
          </motion.span>
          <motion.h1
          ...
          >
            Fresh picks – recently added products handpicked for you.
          </motion.p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-muted/30 rounded-xl">
            <h3 className="font-medium mb-2">No new arrivals yet</h3>
            <p className="text-sm text-muted-foreground mb-4 max-w-sm mx-auto">
              Mark products as &quot;New&quot; in the admin panel to see them here.
            </p>
            <Button asChild>
